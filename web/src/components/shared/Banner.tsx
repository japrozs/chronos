...
export const Banner: React.FC<BannerProps> = ({}) => {
    return (
        <>
            <div className="hidden mid:block mid:flex items-center py-2.5 mid:bg-scribbles border-b border-gray-800">
                ...
                <RxCross2 className="block mr-2 text-white cursor-pointer text-2xl hover:text-primary-color" />
            </div>
